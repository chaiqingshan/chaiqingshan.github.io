...
$(document).ready(function () {
    ...
    (function () {
        ...
        var url = address + "missionController/selectAllByPage";
    ...
    (function () {
        $("a[id='addModalBtn']").click(function () {
            ...
            loginDetect().then(function (response) {
...
function initialTable() {
    ...
    for (var i = 1; i <= (totalPage <= maxPage ? totalPage : maxPage); i++) {
        var a = $("<a class=\"pageIndex\" onclick=\"updateTableAndPagination(this.innerHTML)\"></a>").text(i);
...
function createTable(dataSet) {
    ...
    dataSet.forEach(function (value) {
        var tr = $('<tr></tr>');
        var tdId = $("<td class=\"td-itemId\"></td>").text(value.id); // id
        var tdName = $("<td class=\"td-name\"></td>").text(value.testProjectName); // 编号
        var tdType = $("<td class=\"td-type\"></td>").text(value.type); // 项目id
        var tdProjectCode = $("<td class=\"td-projectCode\"></td>").text(value.testProjectCode); // 名称
        var tdOperation = $("<td class=\"td-operation\"><a data-toggle=\"modal\" class=\"btn btn-view btn-white\" onclick=\"showViewModal(this);\" href=''>\u67E5\u770B</a><a class=\"btn btn-alter btn-white\" onclick=\"showAlterModal(this);\" data-toggle=\"modal\" href=''>\u4FEE\u6539</a></td>");
...
function destructe(data) {
    ...
    newData = data.map(function (value) {
        ...
        newValue.testProjectCode = value.missionName;
        newValue.testProjectName = value.missionCode;
        newValue.type = value.testProjectId;
