...
var total_date;
//按时间加载全部未读报表信息
function getAllUnReadReportInfoByPeriod(token, page_num, start_time, end_time, flag){
	$.ajax({
        type: "post",
        url: baseurl + '/rep/loadUnreadCaseReportByPeriod/',
        data: JSON.stringify({
            "params": {
                "token": token,
                "page_num": page_num,
...
$("#select-button").click(function(){
    ...
    flag = 5;
    $("#div").empty();
    getAllUnReadReportInfoByPeriod(token, page, start_time, end_time, flag);
